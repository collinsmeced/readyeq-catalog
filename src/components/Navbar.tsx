      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-[72px] gap-4">
          ...
          <div className="hidden lg:flex items-center gap-3 shrink-0">
            ...
            <a href="tel:16032797323" className="text-gray-500 hover:text-[#2563eb] transition-colors" aria-label="Call us">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <nav className="hidden lg:flex items-center gap-5 text-sm font-medium text-gray-700 shrink-0">
            <a href={MAIN_SITE} className="hover:text-[#2563eb] transition-colors">Home</a>
            <a href={`${MAIN_SITE}/rentals`} className="hover:text-[#2563eb] transition-colors">Rentals</a>
            <Link href="/" className="text-[#2563eb] font-semibold border-b-2 border-[#2563eb] pb-0.5">Sales</Link>
            <a href={`${MAIN_SITE}/parts-service`} className="hover:text-[#2563eb] transition-colors">Parts &amp; Service</a>
          </nav>
          ...
          {/* Right nav */}
          <nav className="hidden lg:flex items-center gap-5 text-sm font-medium text-gray-700 shrink-0">
            <a href={`${MAIN_SITE}/about`} className="hover:text-[#2563eb] transition-colors">About</a>
            <a href={`${MAIN_SITE}/blog`} className="hover:text-[#2563eb] transition-colors">Blog</a>
            <a href={`${MAIN_SITE}/resources`} className="hover:text-[#2563eb] transition-colors">Resources</a>
            <a href={`${MAIN_SITE}/contact-us`} className="hover:text-[#2563eb] transition-colors">Contact us</a>
          </nav>
