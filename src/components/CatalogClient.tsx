      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-[#0072bc] rounded-xl p-8 text-center text-white mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="tel:16032797323"
               className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-white text-[#0072bc] font-semibold rounded hover:bg-gray-100 transition-colors">
              Call (603) 279-7323
            </a>
            <a href="sms:16032797323"
               className="inline-flex items-center justify-center gap-2 px-5 py-2.5 border-2 border-white text-white font-semibold rounded hover:bg-white/10 transition-colors">
              Text (603) 279-7323
            </a>
            <a href="https://www.readyeq.com/contact-us" target="_blank" rel="noopener noreferrer"
               className="inline-flex items-center justify-center gap-2 px-5 py-2.5 border-2 border-white text-white font-semibold rounded hover:bg-white/10 transition-colors">
              Message Us
            </a>
          </div>
        ...
        <div className="mt-16 bg-[#0F1827] rounded-xl p-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="sms:16032797323" className="btn-secondary justify-center border-gray-500 text-white hover:bg-white/10">
              Text (603) 279-7323
            </a>
